...
import org.openpnp.machine.reference.feeder.wizards.StripFeederSConfigurationWizard;
 ...
 */
public class StripFeederS extends ReferenceFeeder {
    ...
    public Location getPickLocation() throws Exception {
    	return getPickLocation(0);
    }

    public Location getPickLocation(int feedOffset) throws Exception {
    ...
    public Wizard getConfigurationWizard() {
        return new StripFeederSConfigurationWizard(this);
    }
