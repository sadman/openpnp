...
public class StripFeederSConfigurationWizard extends AbstractConfigurationWizard {
    private final StripFeederS feeder;
    ...
    public StripFeederSConfigurationWizard(StripFeederS feeder) {
        this.feeder = feeder;
        ...
        lblReverse = new JLabel("Reverse direction?");
        panelPart.add(lblReverse, "2, 8");

        chckbxReverse = new JCheckBox("");
        panelPart.add(chckbxReverse, "4, 8");
    ...
    public void createBindings() {
        ...
        addWrappedBinding(feeder, "reverse", chckbxReverse, "selected");
